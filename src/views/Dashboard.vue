<template>
    <div class="wrapper" style="margin-top:40px">
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="https://evisacameroun2.webcoom.net/" class="brand-link">
          <img
            src="../../public/logo.png"
            alt="Evisa Logo"
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <img
                          ...
                          src="../../public/assets/dist/img/user1-128x128.jpg"
                      ...
                      <div class="direct-chat-msg right">
                        ...
                        <img
                          class="direct-chat-img"
                          src="../../public/assets/dist/img/user3-128x128.jpg"
                          alt="message user image"
                        />
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                      ...
                      <ul class="contacts-list">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="../../public/assets/dist/img/user7-128x128.jpg"
                              alt="User Avatar"
                            />
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="../../public/assets/dist/img/user5-128x128.jpg"
                              alt="User Avatar"
                            />
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="../../public/assets/dist/img/user6-128x128.jpg"
                              alt="User Avatar"
                            />
